...
<head>
 ...
 <title><?php echo _TITLE; ?></title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo assets_path(); ?>plugins/iCheck/square/blue.css">
...
?>
  ...
  <div class="login-box-body">
    ...
    <form method="post" action="?c=login&a=login">
        <input type="hidden" name="path" value="<?php echo $_SERVER['QUERY_STRING']; ?>">
...
<!-- iCheck -->
<script src="<?php echo assets_path(); ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
