...
final class A_Hook implements Iterator, ArrayAccess 
{
	...
	public function add_filter( $tag, $function_to_add, $priority, $accepted_args ) {
		$idx = _a_filter_build_unique_id( $tag, $function_to_add, $priority );
	...
	public function remove_filter( $tag, $function_to_remove, $priority ) {
		$function_key = _a_filter_build_unique_id( $tag, $function_to_remove, $priority );
	...
	public function has_filter( $tag = '', $function_to_check = false ) {
		...
		$function_key = _a_filter_build_unique_id( $tag, $function_to_check, false );
		if ( ! $function_key ) {
			return false;
		}
	...
	public static function build_preinitialized_hooks( $filters ) {
		...
		foreach ( $filters as $tag => $callback_groups ) {
			if ( is_object( $callback_groups ) && $callback_groups instanceof A_Hook ) {
